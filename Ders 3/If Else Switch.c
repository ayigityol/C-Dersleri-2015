...
|_______/  \______/ |__/       \______/ |______/
 Bir arabanýn hýzýný kullanýcýdan alan ve hýz deðerine göre aracýn nasýl gittiðini söyleyen programý yazýn. 
 1. Hýz > 10, çok yavaþ 
 2. Hýz > 30, yavaþ 
 3. Hýz > 50, orta 
 4. Hýz > 70, hýzlý 
...
/* YANIT BIR ICIN BU SATIRI SIL ------------------------------------------------------
	...
	float hiz = 0.00; // aracýn hýzý için kullanýlacak deðiþken.
...
|_______/  \______/ |__/       \______/ |________/
 ...
 Kullanýcýdan (x,y) þeklinde kordinatýný alan ve kordinatýn 
 kaçýncý bölgede olduðunu yazdýran programý yazýn. 
